...
%--------------------------------------------------------------------------
\title{Social Robots are Fake News}
\subtitle{...so let's make them great again}
\date{\today}
...
\section{Social robots? DISHONEST!}
...
\section{I'd say very very easy if you have guts}
...
\section{I don't understand! Very unfair!}
...
\videoframe[0.56]{figs/this_box.webm}
...
\section{Those are false beliefs!}
...
\section{I will not be forced by a rogue and out of control robot to make up lies and
stories}
...
\videoframe[0.56]{figs/underworlds.mp4?start=20}

\begin{frame}[plain]


    \Huge
    \textbf{Very, very great?}
